...
Description
奶牛们要举办跳石头比赛，在河里从一个岩石跳到另一个岩石。河道在起点和离起点 S 远的终点处均有一个岩石。在起点和终点之间，有 N 个岩石，每个岩石与起点的距离分别为 D
i 。奶牛每一步只能从一个岩石跳到下一个岩石。农夫计划移走一些岩石，使得从起点到终点的过程中，最短的跳跃距离最长。他可以移走除起点和终点外的至多 M 个岩石。
